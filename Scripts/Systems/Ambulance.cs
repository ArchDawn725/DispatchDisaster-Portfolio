...
//    public bool iAmSelected;
    ...
    void Start()
    {
        ...
        {
            gameObject.name = ("Ambulance " + controller.ambulanceNumber.ToString());
        }

        if (gameObject.tag == "AirAmbulance")
        {
            gameObject.name = ("LifeFlight " + controller.airAmbulanceNumber.ToString());
        }
...
//        controller.AmbulanceMenu();
    ...
    {
        if (gameObject.tag == "Ambulance" || gameObject.tag == "AirAmbulance")
        {
