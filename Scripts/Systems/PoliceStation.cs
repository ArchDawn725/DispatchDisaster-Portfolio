...
public class PoliceStation : MonoBehaviour
{
    ...
    public GameObject policePatrolCar;
    public GameObject policeTrooper;
    public GameObject policeSwat;
    public GameObject policeSpotter;
    ...
    void Start()
    {
        ...
        policeStationMenu = Canvas.gameObject.transform.GetChild(3).gameObject;
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "PoliceCar" || other.gameObject.tag == "PoliceEMSHybrid" || other.gameObject.tag == "EMSPoliceFireHybrid" || other.gameObject.tag == "FirePoliceHybrid")
        {
            if (other.GetComponent<Ambulance>() != null)
            {
                ambulanceS = other.GetComponent<Ambulance>();

                if (ambulanceS.CaughtPolice == true)
                {
            ...
            if (other.GetComponent<FireTruck>() != null)
            {
                ...
                if (fireTruckS.CaughtPolice == true)
                {
            ...
            if (other.GetComponent<PoliceCar>() != null)
            {
                ...
                if (policeCarS.CaughtPolice == true)
                {
    ...
    public void SpawnPolicePatrolCar()
    {
        Instantiate(policePatrolCar, here.transform.position, Quaternion.identity);
    }

    public void SpawnPoliceTrooper()
    {
        Instantiate(policeTrooper, here.transform.position, Quaternion.identity);
    }

    public void SpawnPoliceSwat()
    {
        Instantiate(policeSwat, here.transform.position, Quaternion.identity);
    }

    public void SpawnPoliceSpotter()
    {
        Instantiate(policeSpotter, here.transform.position, Quaternion.identity);
    }
    ...
    public void ItemButtonClicked()
    {
        ...
        controller.policeStationS = this;
        controller.PoliceStationMenu();
